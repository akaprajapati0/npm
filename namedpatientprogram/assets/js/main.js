(function ($) {
    ...
    // $(".sidebar-menu").on("click", function () {
    //     $('body').css('overflow', 'hidden').fadeOut(500, function() {
    //       $(this).fadeIn(500);
    //     });
    //   });
    ...
    //       $(this).css('overflow', 'auto').fadeIn(500);
    //     });
    //   });
    ...
    $(document).ready(function () {
        ...
        // Function to remove "sticky" class
        function removeSticky() {
            sticky.removeClass("sticky");
        }
    
        // Remove the "sticky" class on window load
        removeSticky();
        ...
        wind.on("scroll", function () {
            ...
            if (scroll < lastScrollTop) {
                // User is scrolling up, so add the "sticky" class
                sticky.addClass("sticky");
            } else {
                // User is scrolling down, so remove the "sticky" class
                sticky.removeClass("sticky");
            }
    
            lastScrollTop = scroll;
    
            // Check if the user is at the top of the page and remove "sticky" class
            if (scroll === 0) {
                removeSticky();
            }
        });
    ...
    var galleryThumbs = new Swiper(".gallery-thumbs", { spaceBetween: 30, slidesPerView: 2, freeMode: true, watchSlidesVisibility: true, watchSlidesProgress: true });
    var galleryTop = new Swiper(".gallery-top", { spaceBetween: 30, navigation: { nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev" }, thumbs: { swiper: galleryThumbs } });
